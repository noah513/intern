...
RAMFS_TMP="/tmp/arter97-op7-ramdisk-1"
...
cat $KERNELDIR/arch/arm64/boot/Image | sed s/skip_initramfs/want_initramfs/g | pigz -1 -R > $RAMFS_TMP.bin.gz
mkbootimg \
    --kernel $RAMFS_TMP.bin.gz \
